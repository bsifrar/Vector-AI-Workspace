...
from workspace_standalone.workspace_runtime.chat_service import ChatService
from workspace_standalone.workspace_runtime.policy_service import PolicyService
from workspace_standalone.workspace_runtime.settings_service import SettingsService
from workspace_standalone.workspace_runtime.stream_manager import StreamManager
...
class SessionManager:
    ...
    def status(self) -> Dict[str, Any]:
        return {
            "status": "ok",
            "component": "workspace_standalone",
